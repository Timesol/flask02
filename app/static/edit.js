...
function test(){
	...
	xhr.setRequestHeader("Origin", 'https://stackoverflow.com');
$.get('https://stackoverflow.com/questions/44369302/how-to-get-element-by-id-from-another-website').then(function (html) {
    // Success response
    var $question = $(html).find('#question-header');
    document.write($question.html());
}, function () {
    // Error response
