...
c=s.get('https://intern.inode.at/backoffice/contract/contract_config_edit.php4?Contract_ID=1462885')
data=s.get('https://intern.inode.at/backoffice/contract/contract_config_edit.php4?Contract_ID=1462885').content
s.cookies=c.cookies
#s.headers=c.headers
print(c.cookies)
print(c.headers)
